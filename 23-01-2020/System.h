...
private:
int month;
std::vector<double>  cash_desk;//1 cassa contabile //2 cassa disponibile //3 disponibile + futuri incassi
std::vector<double> differentPrice;//I 3 differenti prezzi in base alle quantità
...
void cash_deskUpdate(int numOfComponent);//aggiorna la cassa
